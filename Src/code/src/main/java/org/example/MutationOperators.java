...
public class MutationOperators {
    ...
    public static void applyAMC(CompilationUnit cu) {
    ...
    public static void applyIHI(CompilationUnit cu) {
        cu.accept(new VoidVisitorAdapter<Void>() {
            @Override
    ...
    public static void applyIHD(CompilationUnit cu) {
        cu.accept(new VoidVisitorAdapter<Void>() {
            @Override
            public void visit(ClassOrInterfaceDeclaration n, Void arg) {
                super.visit(n, arg);
    ...
    public static void applyIOD(CompilationUnit cu) {
        cu.accept(new VoidVisitorAdapter<Void>() {
            @Override
            public void visit(ClassOrInterfaceDeclaration n, Void arg) {
                super.visit(n, arg);
    ...
    public static void applyIOP(CompilationUnit cu) {
        cu.accept(new VoidVisitorAdapter<Void>() {
            @Override
    ...
    public static void applyIOR(CompilationUnit cu) {
        cu.accept(new VoidVisitorAdapter<Void>() {
            @Override
    ...
    public static void applyISI(CompilationUnit cu) {
        cu.accept(new VoidVisitorAdapter<Void>() {
            @Override
    ...
    public static void applyISD(CompilationUnit cu) {
        cu.accept(new VoidVisitorAdapter<Void>() {
            @Override
    ...
    public static void applyIPC(CompilationUnit cu) {
...
//    }
    ...
    public static void applyPCC(CompilationUnit cu) {
