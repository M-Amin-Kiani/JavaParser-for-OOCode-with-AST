...
public class code {
    ...
    public static class Car extends Vehicle {
        ...
        public String pDisplayInfo(boolean showDetails) {
            String info = super.pDisplayInfo();
            if (showDetails) {
